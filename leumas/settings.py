"""
Django settings for leumas project.
...
SECRET_KEY = 'django-insecure-rdi2vgvdnz)(kutliviuwh1gcc(-k$0a(^!m*au56=ik&+t-nk'
...
WSGI_APPLICATION = 'leumas.wsgi.application'
